...
import caixin.android.com.entity.SendMessageResponse.ReplayDataBean;
import caixin.android.com.entity.SendMessageResponse.ReplayDataList_Converter;
...
public class SendMessageResponseDao extends AbstractDao<SendMessageResponse, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Is_gl = new Property(32, int.class, "is_gl", false, "IS_GL");
        public final static Property Is_gf = new Property(33, int.class, "is_gf", false, "IS_GF");
    }

    private final ImageList_Converter imgConverter = new ImageList_Converter();
    private final ReplayDataList_Converter reply_dataConverter = new ReplayDataList_Converter();
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEND_MESSAGE_RESPONSE\" (" + //
                ...
                "\"IS_GL\" INTEGER NOT NULL ," + // 32: is_gl
                "\"IS_GF\" INTEGER NOT NULL );"); // 33: is_gf
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SendMessageResponse entity) {
        ...
        ReplayDataBean reply_data = entity.getReply_data();
        if (reply_data != null) {
            stmt.bindString(32, reply_dataConverter.convertToDatabaseValue(reply_data));
        }
        stmt.bindLong(33, entity.getIs_gl());
        stmt.bindLong(34, entity.getIs_gf());
    }
    ...
    public SendMessageResponse readEntity(Cursor cursor, int offset) {
        SendMessageResponse entity = new SendMessageResponse( //
            ...
            cursor.isNull(offset + 31) ? null : reply_dataConverter.convertToEntityProperty(cursor.getString(offset + 31)), // reply_data
            cursor.getInt(offset + 32), // is_gl
            cursor.getInt(offset + 33) // is_gf
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SendMessageResponse entity, int offset) {
        ...
        entity.setReply_data(cursor.isNull(offset + 31) ? null : reply_dataConverter.convertToEntityProperty(cursor.getString(offset + 31)));
        entity.setIs_gl(cursor.getInt(offset + 32));
        entity.setIs_gf(cursor.getInt(offset + 33));
     }
